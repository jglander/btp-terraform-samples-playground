...
variable "service_plan__sap_integration_suite" {
  ...
  validation {
    condition     = contains(["standard_edition"], var.service_plan__sap_integration_suite)
    error_message = "Invalid value for service_plan__sap_integration_suite. Only 'standard_edition' is allowed."
  }
}
...
variable "service_plan__sap_business_app_studio" {
  ...
  default     = "standard"
  validation {
    condition     = contains(["standard"], var.service_plan__sap_business_app_studio)
    error_message = "Invalid value for service_plan__sap_business_app_studio. Only 'standard' is allowed."
  }
}
