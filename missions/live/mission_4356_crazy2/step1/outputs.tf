...
output "integrationsuite_subscription_app_name" {
  value = local.integrationsuite_subscription_app_name
  description = "app_name for integrationsuite subscription"
}

output "integration_provisioners" {
  value = var.integration_provisioners
